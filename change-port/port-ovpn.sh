...
############## WELCOME TO YOLOVPN ###############
############## By YoloNET ###############
setenv FRIENDLY_NAME "YOLOVPN TCP"
client
dev tun
proto tcp
remote $domain 1194
...
############## WELCOME TO YoloVPN ###############
############## By YoloNET ###############
setenv FRIENDLY_NAME "YoloVPN UDP"
client
dev tun
proto udp
remote $domain 2200
...
setenv FRIENDLY_NAME "YOLOVPN OHP"
http-proxy $MYIP $vpn
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By YoloNET
Documentation=https://t.me/rayyolo
...
############## WELCOME TO YOLOVPNVPN ###############
############## By YoloNET ###############
setenv FRIENDLY_NAME "YOLOVPN SSL"
client
dev tun
proto tcp
remote $domain $vpn
